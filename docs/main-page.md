...
> All data below is extracted directly from the official game files at [data.mo.ee](https://data.mo.ee) — automatically generated and kept in sync.
> *Last updated: 2026-08-19*

### 🗡️ Items — 5,587 objects

| Category | Entries | Browse |
| --- | --- | --- |
...
### 👾 Mobs — 904 enemies across 46 zones

[Browse all zones →](/game-data/mobs/dorpat)
...
### 📖 Recipes — 2,431 crafting formulas
